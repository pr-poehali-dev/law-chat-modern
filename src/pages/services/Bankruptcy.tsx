  ...
  const services = [
    {
      ...
      description: 'Комплексное сопровождение процедур банкротства организаций всех форм собственности',
      features: ['Подача заявления о банкротстве', 'Ведение дел в суде', 'Работа с конкурсными управляющими', 'Защита интересов кредиторов']
    },
    {
      title: 'Банкротство физических лиц',
      description: 'Освобождение граждан от долгов через процедуру банкротства с минимальными рисками',
      features: ['Анализ возможности банкротства', 'Подготовка документов', 'Представительство в суде', 'Сопровождение реализации имущества']
    },
    {
      title: 'Оспаривание сделок должника',
      description: 'Признание недействительными сделок, совершенных в ущерб кредиторам',
      features: ['Выявление подозрительных сделок', 'Сбор доказательств', 'Подача заявлений в суд', 'Возврат имущества в конкурсную массу']
    },
    {
      title: 'Антикризисное управление',
      description: 'Предотвращение банкротства и восстановление платежеспособности предприятий',
      features: ['Финансовый анализ предприятия', 'Разработка плана оздоровления', 'Переговоры с кредиторами', 'Реструктуризация долгов']
    }
  ];

  const advantages = [
    { icon: 'Shield', title: '100+ дел', description: 'о банкротстве ведем' },
    { icon: 'TrendingUp', title: '80%', description: 'успешных процедур' },
    { icon: 'Clock', title: '6-12 мес', description: 'средний срок процедуры' },
    { icon: 'DollarSign', title: 'Экономия', description: 'до 90% долгов' }
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex justify-center mb-8">
              <div className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center">
                <Icon name="TrendingDown" size={40} className="text-primary" />
              </div>
            </div>
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Профессиональное сопровождение процедур банкротства физических и юридических лиц
              с защитой интересов всех участников процесса
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Полный спектр услуг в сфере банкротства и антикризисного управления
            </p>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Мы обеспечиваем эффективное и законное проведение процедур банкротства
            </p>
          </div>
      ...
      <section className="py-32 bg-primary text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">Сложности с долгами?</h2>
          <p className="text-xl mb-12 max-w-2xl mx-auto opacity-90">
            Получите бесплатную консультацию по возможности проведения процедуры банкротства
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12">
            <div className="md:col-span-1">
              ...
              <p className="text-gray-400 leading-relaxed">Профессиональные услуги в сфере банкротства и антикризисного управления</p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-300">
                <p>Банкротство юридических лиц</p>
                <p>Банкротство физических лиц</p>
                <p>Оспаривание сделок должника</p>
