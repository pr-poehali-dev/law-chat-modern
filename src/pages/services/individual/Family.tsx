...
const Family = () => {
  const services = [
    {
      ...
      description: 'Правовое сопровождение расторжения брака и справедливый раздел имущества',
      features: ['Подготовка искового заявления', 'Оценка совместного имущества', 'Защита интересов в суде', 'Исполнение решений суда']
    },
    {
      title: 'Алименты и содержание',
      description: 'Взыскание и изменение размера алиментов на детей и супругов',
      features: ['Взыскание алиментов на детей', 'Алименты на содержание супруга', 'Изменение размера алиментов', 'Взыскание задолженности']
    },
    {
      title: 'Споры о детях',
      description: 'Защита прав и интересов детей в семейных спорах',
      features: ['Определение места жительства', 'Порядок общения с ребенком', 'Лишение родительских прав', 'Усыновление и опека']
    },
    {
      title: 'Брачные договоры',
      description: 'Составление и изменение брачных договоров для защиты имущества',
      features: ['Разработка брачного договора', 'Изменение условий договора', 'Признание договора недействительным', 'Защита имущественных прав']
    }
  ];

  const advantages = [
    { icon: 'Heart', title: '150+', description: 'семейных дел' },
    { icon: 'Users', title: '85%', description: 'мирных соглашений' },
    { icon: 'Shield', title: 'Защита', description: 'прав детей' },
    { icon: 'Clock', title: '2-6 мес', description: 'средний срок дела' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-96 pb-32 bg-gradient-to-br from-rose-50 to-pink-100">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Деликатное решение семейных конфликтов с защитой интересов всех членов семьи, 
              особенно детей
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <Button variant="outline" size="lg" className="h-14 px-8 text-lg">
                <Icon name="MessageHeart" size={20} className="mr-2" />
                Семейная медиация
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Профессиональная помощь в решении семейных споров с заботой о ваших близких
            </p>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Деликатный подход к семейным вопросам с заботой о детях
            </p>
          </div>
      ...
      <section className="py-32 bg-primary text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">Семейные проблемы?</h2>
          <p className="text-xl mb-12 max-w-2xl mx-auto opacity-90">
            Получите деликатную консультацию по семейным вопросам с защитой интересов детей
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">Семейное право с заботой о ваших близких</p>
            </div>
