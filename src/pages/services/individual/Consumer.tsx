...
const Consumer = () => {
  const services = [
    {
      title: 'Защита прав покупателей',
      description: 'Возврат товаров, компенсация ущерба и защита от недобросовестных продавцов',
      features: ['Возврат некачественного товара', 'Возмещение морального вреда', 'Нарушение сроков поставки', 'Гарантийное обслуживание']
    },
    {
      title: 'Споры с услугами',
      description: 'Защита прав потребителей при оказании некачественных услуг',
      features: ['Туристические услуги', 'Медицинские услуги', 'Образовательные услуги', 'Коммунальные услуги']
    },
    {
      title: 'Финансовые услуги',
      description: 'Защита от недобросовестных действий банков, МФО и страховых компаний',
      features: ['Банковские споры', 'Страховые выплаты', 'Микрофинансирование', 'Коллекторские агентства']
    },
    {
      title: 'Интернет-торговля',
      description: 'Защита прав при покупках в интернет-магазинах и на маркетплейсах',
      features: ['Возврат товаров', 'Мошенничество в сети', 'Нарушение сроков доставки', 'Качество интернет-покупок']
    }
  ];

  const advantages = [
    { icon: 'ShoppingCart', title: '300+', description: 'потребительских споров' },
    { icon: 'Trophy', title: '95%', description: 'успешных дел' },
    { icon: 'DollarSign', title: '5 млн ₽', description: 'взыскано для клиентов' },
    { icon: 'Clock', title: '1-3 мес', description: 'средний срок дела' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-96 pb-32 bg-gradient-to-br from-teal-50 to-cyan-100">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Защищаем права потребителей при покупке товаров и услуг, 
              взыскиваем компенсации и наказываем недобросовестных продавцов
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Полная защита прав потребителей во всех сферах товаров и услуг
            </p>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Эффективная защита потребительских прав с максимальными компенсациями
            </p>
          </div>
      ...
      <section className="py-32 bg-primary text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto opacity-90">
            Получите бесплатную консультацию по защите ваших потребительских прав
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400">Защита прав потребителей товаров и услуг</p>
            </div>
