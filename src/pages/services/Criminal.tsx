...
const Criminal = () => {
  const services = [
    {
      ...
      features: ['Участие в следственных действиях', 'Обжалование постановлений следователя', 'Защита в суде первой инстанции', 'Апелляционное обжалование']
    },
    {
      title: 'Экономические преступления',
      description: 'Защита по делам о преступлениях в сфере экономической деятельности',
      features: ['Мошенничество в сфере бизнеса', 'Налоговые преступления', 'Легализация доходов', 'Злоупотребление полномочиями']
    },
    {
      title: 'Белые воротнички',
      description: 'Защита руководителей и должностных лиц от уголовного преследования',
      features: ['Коррупционные преступления', 'Злоупотребление должностными полномочиями', 'Превышение полномочий', 'Служебный подлог']
    },
    {
      title: 'Досудебная защита',
      description: 'Защита интересов на стадии предварительного расследования',
      features: ['Участие в допросах', 'Заявление ходатайств', 'Ознакомление с материалами дела', 'Обжалование действий следствия']
    }
  ];

  const advantages = [
    { icon: 'Shield', title: '200+ дел', description: 'по уголовной защите' },
    { icon: 'Users', title: '90%', description: 'клиентов избежали реального срока' },
    { icon: 'Award', title: '15 лет', description: 'опыта в уголовном праве' },
    { icon: 'Clock', title: '24/7', description: 'экстренная помощь' }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative pt-96 pb-32 bg-gradient-to-br from-slate-50 to-gray-100">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Профессиональная защита по уголовным делам любой сложности 
              с максимальной защитой прав и свобод клиентов
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Полный спектр услуг по уголовно-правовой защите на всех стадиях процесса
            </p>
          </div>
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Мы обеспечиваем максимальную защиту прав и интересов клиентов по уголовным делам
            </p>
          </div>
      ...
      <section className="py-32 bg-primary text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto opacity-90">
            Получите экстренную консультацию по уголовному делу. Конфиденциальность гарантируем.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12">
            <div className="md:col-span-1">
              ...
              <p className="text-gray-400 leading-relaxed">Профессиональная уголовно-правовая защита с гарантией конфиденциальности</p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-300">
                <p>Защита в уголовных делах</p>
                <p>Экономические преступления</p>
                <p>Белые воротнички</p>
                <p>Досудебная защита</p>
              </div>
            </div>
